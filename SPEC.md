...
| `POLL_INTERVAL_S` | `5` | Seconds between `_await_run` status polls; balances event-loop yielding against CI API call rate. 5 s ≈ 1% of `CI_WAIT_S` budget, safely below typical CI API rate limits. |
