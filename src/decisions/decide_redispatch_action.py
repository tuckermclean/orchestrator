...
def decide_redispatch_action(
    ...
    Row 1: has_open_pr                              → skip-has-pr
    Row 2: seconds_since_last_activity < COOLDOWN   → skip-recent
    Row 3: redispatch_count >= ISSUE_REDISPATCH_CAP → escalate
    Row 4: else                                     → redispatch
